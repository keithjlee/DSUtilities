...
namespace DSUtilities.Generators
{
    public class DenseGroundStructure : GroundStructure
    {
        ...
        public DenseGroundStructure(Surface surface, int nx, int ny)
        {
            ...
            List<Point3d> points = GroundStructureGeneration.GetPointGrid(surface, nx, dx, ny, dy, out int[,] igrid, out List<int> iflat);
