...
{
    public class ControlSurfacePoint : GH_Component
    {
        ...
        /// <summary>
        /// Initializes a new instance of the ControlSurfacePoint class.
        /// </summary>
        public ControlSurfacePoint()
          : base("ControlSurfacePoint", "CtrlSurfPoint",
              "Description",
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddPointParameter("Points", "Points", "Points to control", GH_ParamAccess.list);
        ...
        {
            get { return new Guid("9988EB54-ADA5-483B-A074-FD58C869E0B9"); }
        }
    }
}